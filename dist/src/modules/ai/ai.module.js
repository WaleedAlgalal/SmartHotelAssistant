...
const sql_knowledge_service_1 = require("./infrastructure/rag/sql-knowledge.service");
...
exports.AiModule = AiModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [
            ...
            sql_knowledge_service_1.SqlKnowledgeService,
            {
                provide: ai_tokens_1.AI_KNOWLEDGE_REPOSITORY,
                useExisting: sql_knowledge_service_1.SqlKnowledgeService,
            },
        ],
    })
], AiModule);
